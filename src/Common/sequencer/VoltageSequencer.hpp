...
struct VoltageSequencer : Sequencer
{
    ...
    */
    ...
    // These functions are mostly for backwards compatibility
    ...
    void setDefault(double new_default_value)
    {
        // Set both unipolar and bipolar default values
        this->unipolar_default_value = new_default_value;
        this->bipolar_default_value = new_default_value;
    }
