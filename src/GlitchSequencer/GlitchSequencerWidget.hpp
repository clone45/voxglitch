struct GlitchSequencerWidget : VoxglitchModuleWidget
{
  GlitchSequencerWidget(GlitchSequencer* module)
  {
    ...
    addParam(createParamCentered<VoxglitchRoundToggleLampSwitch>(themePos("TRIGGER_GROUP_BUTTONS_3"), module, GlitchSequencer::TRIGGER_GROUP_BUTTONS + 2));
    addParam(createParamCentered<VoxglitchRoundToggleLampSwitch>(themePos("TRIGGER_GROUP_BUTTONS_4"), module, GlitchSequencer::TRIGGER_GROUP_BUTTONS + 3));
    addParam(createParamCentered<VoxglitchRoundToggleLampSwitch>(themePos("TRIGGER_GROUP_BUTTONS_5"), module, GlitchSequencer::TRIGGER_GROUP_BUTTONS + 4));
    addParam(createParamCentered<VoxglitchRoundToggleLampSwitch>(themePos("TRIGGER_GROUP_BUTTONS_6"), module, GlitchSequencer::TRIGGER_GROUP_BUTTONS + 5));
    addParam(createParamCentered<VoxglitchRoundToggleLampSwitch>(themePos("TRIGGER_GROUP_BUTTONS_7"), module, GlitchSequencer::TRIGGER_GROUP_BUTTONS + 6));
    addParam(createParamCentered<VoxglitchRoundToggleLampSwitch>(themePos("TRIGGER_GROUP_BUTTONS_8"), module, GlitchSequencer::TRIGGER_GROUP_BUTTONS + 7));
