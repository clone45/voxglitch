struct InnerWidget : VoxglitchModuleWidget
{
  InnerWidget(Inner *module)
  {
    ...
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(64.94, 20.702)), module, Inner::PARAM5_CV_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(64.94, 40.702)), module, Inner::PARAM6_CV_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(64.94, 60.702)), module, Inner::PARAM7_CV_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(64.94, 80.702)), module, Inner::PARAM8_CV_INPUT));
